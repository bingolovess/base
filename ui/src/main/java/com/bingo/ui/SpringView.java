...
public class SpringView extends ViewGroup {
    ...
    static class AnimListenerAdapter extends AnimatorListenerAdapter {
        private final WeakReference<SpringView> reference;

        AnimListenerAdapter(SpringView view) {
    ...
    static class AnimUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        AnimUpdateListener(SpringView view) {
            this.reference = new WeakReference<>(view);
        }
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SpringView);
        mEnable = typedArray.getBoolean(R.styleable.SpringView_lib_pub_spring_enable, true);
        mGravity = typedArray.getInt(R.styleable.SpringView_lib_pub_spring_gravity, 0x11);
        typedArray.recycle();
    }
