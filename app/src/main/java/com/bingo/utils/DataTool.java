...
import static com.bingo.Constants.BYTE;
import static com.bingo.Constants.GB;
import static com.bingo.Constants.KB;
import static com.bingo.Constants.MB;
...
public class DataTool {
     ...
     * @param byteNum 字节数
     * @param unit   <ul>
     *                  <li>{@link Constants.MemoryUnit#BYTE}: 字节</li>
     *                  <li>{@link Constants.MemoryUnit#KB}  : 千字节</li>
     *                  <li>{@link Constants.MemoryUnit#MB}  : 兆</li>
     *                  <li>{@link Constants.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, Constants.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, Constants.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
