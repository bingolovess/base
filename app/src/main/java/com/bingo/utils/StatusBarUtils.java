 ...
 * ========================================================================
 * 简单的沉浸式不带图片
 * StatusBarUtils.with(this).setColor(getResources().getColor(R.color.blue)).init();
 * 带图片的沉浸式
 * StatusBarUtils.with(this).init();
 * 侧滑抽屉栏
 * StatusBarUtils.with(this).setDrawerLayoutContentId(true, R.id.rl_content).setColor(getResources().getColor(R.color.blue)).init();
 * ========================================================================
 */
