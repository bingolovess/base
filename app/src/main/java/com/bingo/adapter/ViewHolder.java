...
public class ViewHolder<T> {
    ...
    public <F extends View> F getView(@IdRes int viewId) {
    ...
    public ViewHolder addOnClickListener(@IdRes final int viewId, View.OnClickListener clickListener) {
    ...
    public ViewHolder setAdapter(@IdRes int viewId, RecyclerView.Adapter adapter) {
        View view = getView(viewId);
        if (null != view) {
