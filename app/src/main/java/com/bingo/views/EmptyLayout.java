...
public class EmptyLayout extends FrameLayout {
    ...
    @IntDef({STATE_LOADING, STATE_EMPTY, STATE_NET_ERROR,
            EmptyLayout.VISIBLE, EmptyLayout.INVISIBLE, EmptyLayout.GONE})
    ...
    public EmptyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        layoutId = typedArray.getResourceId(R.styleable.lib_pub_DSLayout_lib_pub_dsl_layout, R.layout.lib_empty_layout);
    ...
    protected void init(Context context) {
        ...
        ldlLoading.setLoadingColor(R.color.black);
